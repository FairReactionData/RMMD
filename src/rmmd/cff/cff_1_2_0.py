"""
Pydantic model generated from the Citation File Format (CFF) schema version 1.2.0 [1]
using datamodel-codegen (v0.66.2). CFF is licensed under CC-BY-4.0.

[1] Druskat, S.; Spaaks, J. H.; Chue Hong, N.; Haines, R.; Baker, J.; Bliven, S.;
    Willighagen, E.; Pérez-Suárez, D.; Konovalov, O. Citation File Format (Version
    1.2.0) [Computer software], 2021. https://doi.org/10.5281/zenodo.5171937.
"""
...
class PostCode(RootModel[constr(min_length=1) | float]):
    root: constr(min_length=1) | float = Field(..., description="A post code.")
...
class Version(RootModel[constr(min_length=1) | float]):
    root: constr(min_length=1) | float
...
class Entity(BaseModel):
    ...
    address: Address | None = Field(None, description="The entity's address.")
    alias: Alias | None = Field(None, description="The entity's alias.")
    city: City | None = Field(None, description="The entity's city.")
    country: Country | None = Field(None, description="The entity's country.")
    ...
    email: Email | None = Field(None, description="The entity's email address.")
    fax: Fax | None = Field(None, description="The entity's fax number.")
    location: constr(min_length=1) | None = Field(
        None,
    ...
    orcid: Orcid | None = Field(None, description="The entity's orcid.")
    post_code: PostCode | None = Field(
        None, alias="post-code", description="The entity's post code."
    )
    region: Region | None = Field(None, description="The entity's region.")
    tel: Tel | None = Field(None, description="The entity's telephone number.")
    website: Url | None = Field(None, description="The entity's website.")
...
class Identifier1(BaseModel):
    ...
    description: IdentifierDescription | None = None
    type: Type1
    value: Doi
...
class Identifier(RootModel[Identifier1 | Identifier2 | Identifier3 | Identifier4]):
    root: Identifier1 | Identifier2 | Identifier3 | Identifier4 = Field(
        ..., description="An identifier for a work."
    )


class License(RootModel[LicenseEnum | list[LicenseEnum]]):
    root: LicenseEnum | list[LicenseEnum] = Field(
...
class Person(BaseModel):
    ...
    address: Address | None = Field(None, description="The person's address.")
    affiliation: constr(min_length=1) | None = Field(
        None, description="The person's affilitation."
    )
    alias: Alias | None = Field(None, description="The person's alias.")
    city: City | None = Field(None, description="The person's city.")
    country: Country | None = Field(None, description="The person's country.")
    email: Email | None = Field(None, description="The person's email address.")
    family_names: constr(min_length=1) | None = Field(
        None, alias="family-names", description="The person's family names."
    )
    fax: Fax | None = Field(None, description="The person's fax number.")
    given_names: constr(min_length=1) | None = Field(
        None, alias="given-names", description="The person's given names."
    )
    name_particle: constr(min_length=1) | None = Field(
        None,
        alias="name-particle",
    ...
    name_suffix: constr(min_length=1) | None = Field(
        None,
        alias="name-suffix",
        description="The person's name-suffix, e.g. 'Jr.' for Sammy Davis Jr. or 'III' for Frank Edwin Wright III.",
        examples=["Jr.", "III"],
    )
    orcid: Orcid | None = Field(None, description="The person's ORCID.")
    post_code: PostCode | None = Field(
        None, alias="post-code", description="The person's post-code."
    )
    region: Region | None = Field(None, description="The person's region.")
    tel: Tel | None = Field(None, description="The person's phone number.")
    website: Url | None = Field(None, description="The person's website.")
